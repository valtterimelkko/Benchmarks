...
DEFAULT_NOTES = [
    ...
    "DeepSWE, GDPval-AA, the Artificial Analysis Agentic Index, Terminal-Bench, BrowseComp and OSWorld are the strongest fits for day-to-day agent/tool-use choices; LongBench v2 and LMArena are supporting signals for long-context and writing tasks.",
]
